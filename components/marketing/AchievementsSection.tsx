    ...
    <section id="achievements" className="relative py-20 bg-slate-950 text-white overflow-hidden border-b border-slate-800">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <RevealOnScroll className="lg:col-span-7 flex flex-col">
          ...
          {/* Watch Next Playlist Sidebar (Right 5/12) - Perfectly Sized to Match Left Video Player Height */}
          <RevealOnScroll className="lg:col-span-5 flex flex-col h-full">
            <div className="bg-slate-900/40 backdrop-blur-md border border-white/10 rounded-2xl p-4 sm:p-5 flex flex-col gap-3 h-full justify-between">
              ...
              {/* Video List proportioned to match left video player height */}
                ...
                {ACHIEVEMENTS_VIDEOS.map((video) => {
                  ...
                  return (
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      className={`relative flex items-center gap-3 p-2.5 rounded-xl transition text-left group flex-1 ${
                        isActive
