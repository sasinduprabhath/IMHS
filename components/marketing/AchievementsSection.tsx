    ...
    <section id="achievements" className="relative py-20 bg-slate-950 text-white overflow-hidden border-b border-slate-800">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          {/* Watch Next Playlist Sidebar (Right 5/12) - Pinned to match Left Video Height */}
          <RevealOnScroll className="lg:col-span-5 relative w-full h-full min-h-[360px] lg:min-h-0">
            <div className="lg:absolute lg:inset-0 bg-slate-900/40 backdrop-blur-md border border-white/10 rounded-2xl p-3 sm:p-3.5 flex flex-col gap-2 justify-between">
