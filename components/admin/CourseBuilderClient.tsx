...
export function CourseBuilderClient({ course, allFaculty }: CourseBuilderProps) {
  ...
  return (
    <div className="space-y-0 max-w-5xl mx-auto">
      ...
      <div className="sticky top-0 z-30 bg-[#F0F5FB]/95 backdrop-blur-md -mt-8 pt-6 pb-4 mb-6 border-b border-slate-200/80 shadow-2xs transition-all">
        {/* Page Header */}
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-chart-grid/70 mb-4">
          <div>
            <button
              type="button"
          ...
          <div className="flex flex-wrap items-center gap-3 shrink-0">
            ...
            <Button
              ...
              variant="default"
              size="lg"
              className="gap-2 font-semibold shadow-sm bg-[#0E57A4] hover:bg-[#0c4a8e] text-white border-0 shrink-0 cursor-pointer"
            >
        ...
        {/* Save Feedback */}
        {saveSuccess && (
          <div className="mb-3 bg-clinical-teal-surface border border-clinical-teal/30 p-3 rounded-card text-xs font-mono text-clinical-teal flex items-center gap-2 animate-in fade-in">
            <CheckCircle2 className="w-4 h-4 shrink-0" />
            All changes saved successfully!
          </div>
        )}
        {saveError && (
          <div className="mb-3 bg-chart-red/8 border border-chart-red/30 p-3 rounded-card text-xs font-mono text-chart-red flex items-center gap-2">
            ⚠️ {saveError}
          </div>
        )}

        {/* Tab Bar */}
        <div className="flex items-center gap-1 bg-white/80 p-1 rounded-card border border-chart-grid shadow-2xs overflow-x-auto">
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  activeTab === id
                    ? "bg-[#0E57A4] text-white shadow-xs border border-[#0E57A4]"
