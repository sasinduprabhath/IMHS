...
NEXT_PUBLIC_WHATSAPP_NUMBER="+94766506621"
...
> If you run `prisma/seed.ts`, it creates a default administrator (`admin@imhsedu.com`) with the initial password `admin123`.
