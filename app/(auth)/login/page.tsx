...
export default function LoginPage() {
  return (
    <div className="w-full flex-1 min-h-[calc(100vh-68px)] flex items-stretch font-sans overflow-hidden">
      {/* Left brand panel */}
      <div
        className="hidden lg:flex lg:w-[45%] xl:w-[50%] flex-col justify-center gap-6 p-8 xl:p-12 relative overflow-hidden self-stretch"
      ...
      {/* Right form panel */}
      <div
        className="flex-1 flex flex-col items-center justify-center px-4 sm:px-6 py-4 relative overflow-hidden self-stretch"
