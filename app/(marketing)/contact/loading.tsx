    ...
    <div className="min-h-screen bg-surface flex flex-col pt-28">
      ...
      <section className="relative bg-linen/40 border-b border-chart-grid pt-32 pb-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center space-y-4">
          <BrandedSkeleton variant="badge" className="mx-auto" />
          <BrandedSkeleton className="h-10 sm:h-12 w-3/4 mx-auto" />
          <BrandedSkeleton className="h-4 w-5/6 mx-auto" />
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="space-y-3">
              {[1, 2, 3, 4, 5].map((i) => (
                <div key={i} className="p-4 bg-surface border border-chart-grid rounded-card flex items-start gap-4 shadow-sm">
                  <BrandedSkeleton variant="circle" className="w-10 h-10 rounded-xl" />
            ...
            <div className="p-6 bg-clinical-teal-surface border border-clinical-teal/30 rounded-card space-y-3">
              <BrandedSkeleton className="h-5 w-48" />
          ...
          <div className="lg:col-span-7">
            <div className="bg-surface border border-chart-grid p-6 sm:p-8 rounded-card space-y-6 shadow-paper">
              <div className="space-y-2 border-b border-chart-grid pb-4">
                <BrandedSkeleton className="h-6 w-44" />
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <BrandedSkeleton className="h-4 w-24" />
                  <BrandedSkeleton className="h-28 w-full" />
                </div>

                <BrandedSkeleton variant="button" className="w-full h-12" />
              </div>
            </div>
          </div>
        </div>
