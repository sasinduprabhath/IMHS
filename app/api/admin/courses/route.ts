...
const courseSchema = z.object({
  ...
  enrollmentValidity: z.string().default("Batch Intake Access"),
  ...
  try {
    ...
    const newCourse = await prisma.course.create({
      data: {
        ...
        enrollmentValidity: data.enrollmentValidity && !data.enrollmentValidity.toLowerCase().includes("lifetime") ? data.enrollmentValidity : "Batch Intake Access",
